...
if(!process.env.GEMINI_API_KEY){
    console.error('FATAL ERROR: GEMINI_APT_KEY is not set on the environment variables.')
    process.exit(1);
}
/** 
 * @param {string} text
...
export const generateSummary = async (text) =>{
    const prompt = `Provide a concise summary of the following text, highlighting the key concepts, min ideas, and important points.
...
export const explainConcept = async (concept,context) =>{
    ...
    Provide a clear, educaional explanation that's easy to understand.
