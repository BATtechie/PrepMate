 ...
 * @return {Array<{content: string, chunkIndex: number, pageNumber: number}>} - An array of text chunks with their starting indices.
 */
...
export const chunkText = (text, chunkSize = 500, overlap = 50) => {
  ...
  // Clean text while preserving paragraph str
  ...
  for (const paragraph of paragraphs) {
    ...
    // If adding the paragraph exceeds chunk size, finalize current chunk
    ...
    if (
      ...
      const prevChunkWords = prevChunkText.split(/\s+/);
 ...
 * @return {Array<Object>} - An array of relevant text chunks.
 */
